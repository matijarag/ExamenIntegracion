                            ...
                            <?php if(Auth::user()->activo == 1): ?>
                                    <div class="container">
                                        ...
                                        <div class="alert alert-success" role="alert">
                                                ...
                                                lo habilite para volver a tomar hora, si se ausenta una segunda vez,por normativa de duoc, no podra volver a
                                            agendar una hora</li>
                                                </ul>
                                                </div>
                                        <?php endif; ?>
                            ...
                            <?php if(Auth::user()->activo == 0 && Auth::user()->contador == 2): ?>
                                    <div class="container">
                                        <h1>Usted se ausento 2 veces a una hora agendada, por lo cual por normativa<br>
                                            de DuocUC a usted se le ha bloqueado la posibilidad de tomar horas
                                        </h1>
                                    </div>
                            <?php endif; ?>
                            <?php if(Auth::user()->activo == 0 && Auth::user()->contador == 0): ?>
                            <div class="container">
                                <h1>Usted ya ha tomado su hora, favor de asistir, ya que si no lo hace solo podra volver a tomar 1 vez mas una hora
                                </h1>
                            </div>
