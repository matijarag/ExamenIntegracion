                            ...
                            <table class="table" >
                                ...
                                <?php $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tbody>
                                        ...
                                        <input type="hidden" value="<?php echo e($modulo->id_mod); ?>" name="id_mod" >
                                    </tbody>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                                <input type="hidden" value="<?php echo e($fecha); ?>" name="fecha">
                                <input type="hidden" value="<?php echo e($id_usu); ?>" name="id_usu"/>
